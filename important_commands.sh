...
mkdir cdk-pipeline
cd cdk-pipeline || echo "Make sure that the folder exists"
...
# Before running CDK commands, access the Python virtual environment
source .venv/bin/activate || echo "Make sure that virtual env exists"

cdk bootstrap

# Stack
cdk synthesize --app "python3 app.py"
